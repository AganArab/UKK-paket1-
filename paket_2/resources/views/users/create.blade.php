                ...
                <form action="{{ route('users.store') }}" method="POST" id="userForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <label class="radio-option @if(old('role') == 'admin') selected @endif">
                                <input type="radio"
                                       name="role"
                                       value="admin"
                            ...
                            <label class="radio-option @if(old('role') == 'petugas') selected @endif">
                                <input type="radio"
                                       name="role"
                                       value="petugas"
                            ...
                            <label class="radio-option @if(old('role') == 'owner') selected @endif">
                                <input type="radio"
                                       name="role"
                                       value="owner"
                                       @if(old('role') == 'owner') checked @endif>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <label class="radio-option @if(old('status_aktif', 1) == 1) selected @endif">
                                <input type="radio"
                                       name="status_aktif"
                                       value="1"
                                       @if(old('status_aktif', 1) == 1) checked @endif
                                       required>
                                <i class="fas fa-check-circle text-success me-1"></i>
                                <span>Aktif</span>
                            </label>
                            <label class="radio-option @if(old('status_aktif') == '0') selected @endif">
                                <input type="radio"
                                       name="status_aktif"
                                       value="0"
                                       @if(old('status_aktif') == '0') checked @endif>
