...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('kendaraan.store') }}" method="POST" id="kendaraanForm">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <label class="radio-option @if(old('jenis_kendaraan') == 'motor') selected @endif">
                                <input type="radio"
                                       name="jenis_kendaraan"
                                       value="motor"
                                       @if(old('jenis_kendaraan') == 'motor') checked @endif
                                       required>
                            ...
                            <label class="radio-option @if(old('jenis_kendaraan') == 'mobil') selected @endif">
                                <input type="radio"
                                       name="jenis_kendaraan"
                                       value="mobil"
                                       @if(old('jenis_kendaraan') == 'mobil') checked @endif>
                            ...
                            <label class="radio-option @if(old('jenis_kendaraan') == 'lainnya') selected @endif">
                                <input type="radio"
                                       name="jenis_kendaraan"
                                       value="lainnya"
                                       @if(old('jenis_kendaraan') == 'lainnya') checked @endif>
                    ...
                    <div class="vehicle-preview" id="vehiclePreview" style="display: none;">
                        ...
                        <div class="vehicle-text">
                            ...
                            <p id="previewPlat">Plat nomor akan muncul di sini</p>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updatePreview(jenis) {
            ...
            if (jenis) {
                ...
                const platInput = document.getElementById('plat_nomor').value;
                plat.textContent = platInput || 'Plat nomor akan muncul di sini';
            }
        }

        // Update preview when plat nomor changes
        document.getElementById('plat_nomor').addEventListener('input', function() {
            const selectedRadio = document.querySelector('input[name="jenis_kendaraan"]:checked');
            if (selectedRadio) {
                updatePreview(selectedRadio.value);
            }
        });
