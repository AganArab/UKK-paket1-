...
<head>
    ...
    <title>Laporan Peminjaman - Workshop Kit</title>
...
<body>
    <div class="print-buttons no-print">
        ...
        <a href="{{ route('borrowings.index') }}" class="btn"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
    </div>

    <div class="print-header">
        <h1><i class="fa-solid fa-hand-holding-box"></i> Laporan Peminjaman Alat</h1>
    ...
    <div class="print-footer">
        <p>Total Peminjaman: {{ $borrowings->count() }} | Laporan ini digenerate otomatis oleh sistem</p>
    </div>
    @else
    <div class="no-data">
        <p>Tidak ada data peminjaman untuk ditampilkan</p>
    </div>
    @endif
</body>
</html>
